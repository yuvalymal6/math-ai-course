...
const SUBTOPICS = [
  ...
  { id: "quadrilaterals", href: "/3u/topic/grade10/geometry/quadrilaterals", symbol: "\u25A1", title: "מרובעים", description: "מקבילית, מלבן, מעוין, ריבוע, טרפז — תכונות, שטח והיקף", color: "#7c3aed", ready: true },
  { id: "similarity", href: "/3u/topic/grade10/geometry/similarity", symbol: "\u223C", title: "דמיון", description: "משולשים דומים, יחס דמיון, משפטי דמיון (ז.ז., צ.ז.צ., צ.צ.צ.)", color: "#EA580C", ready: true },
    ...
    <main dir="rtl" style={{ minHeight: "100vh", background: "#F3EFE0", backgroundImage: "radial-gradient(rgba(60,54,42,0.07) 1px, transparent 1px)", backgroundSize: "24px 24px" }}>
      ...
      <div style={{ maxWidth: "56rem", margin: "0 auto", padding: "2.5rem 1rem 5rem" }}>
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <p style={{ color: "#2D3436", fontSize: 16, fontWeight: 500 }}>משולשים, מרובעים, שטח, היקף ודמיון — ואיך לשאול AI את השאלות הנכונות</p>
        </div>
