...
const SUBTOPICS = [
  ...
  { id: "proofs", href: "/3u/topic/grade11/geometry/proofs", symbol: "∴", title: "הוכחות גיאומטריות", description: "בניית הוכחה שלב אחר שלב — נתון, מבוקש, טענה ונימוק", color: "#EA580C", ready: false },
