...
const exercises: ExerciseDef[] = [
  {
    ...
    goldenPrompt: `היי, אני תלמיד/ה כיתה יא', 3 יחידות, ומצרף/ת שאלה בסטטיסטיקה על הכרת ההתפלגות הנורמלית — צורת הגרף, ממוצע, סימטריה וכלל 68-95-99.7. אני רוצה שתהיה המורה הפרטי שלי — תעזור לי להבין ולא לתת תשובות ישירות.
...
אל תמהר, תסביר לי על כל שלב. בסיום הסריקה של הנתונים שהדבקתי, תגיב אך ורק: ״אני מוכן להמשיך.״`,
  ...
  },
  {
    ...
    goldenPrompt: `אני בכיתה יא', 3 יחידות, מצרף/ת תרגיל בסטטיסטיקה על חישוב אחוזים בהתפלגות נורמלית לפי כלל 68-95-99.7.
    ...
    >
      ...
      <div style={{ borderBottom: "1px solid rgba(60,54,42,0.15)", background: "#F3EFE0" }}>
        <div style={{ maxWidth: "56rem", margin: "0 auto", padding: "0.9rem 1.5rem", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1rem" }}>
          <div>
            <h1 style={{ fontSize: 22, fontWeight: 700, color: "#2D3436", margin: 0 }}>התפלגות נורמלית עם AI — כיתה יא׳ (3 יח׳)</h1>
      ...
      <div style={{ maxWidth: "56rem", margin: "0 auto", padding: "2rem 1rem 5rem" }}>
        ...
        <SubtopicProgress subtopicId="3u/grade11/statistics/normal" />
        ...
        <div style={{ marginTop: "1.5rem" }}>
          <MarkComplete subtopicId="3u/grade11/statistics/normal" level={selectedLevel} />
        </div>
