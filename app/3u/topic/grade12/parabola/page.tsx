...
import { Brain, ChevronRight, TrendingDown, Maximize2 } from "lucide-react";
...
const SUBTOPICS = [
  {
    ...
    description: "בניית מודל ריבועי מנתונים, מציאת שורשים בעזרת נוסחת השורשים, וקביעת קודקוד הפרבולה.",
    chips: ["Δ = b²−4ac", "x = −b/2a", "f(x) = a(x−p)²+k"],
    ready: true, glowAnim: false,
    iconBg: "bg-orange-500/10", iconBorder: "border-orange-500/30", iconText: "text-orange-400",
    hoverBorder: "hover:border-orange-500/50",
    badgeBg: "bg-orange-500/10 border-orange-500/30", badgeText: "text-orange-400",
    chevronHover: "group-hover:text-orange-400",
  },
  {
    id: "optimization",
    href: "/3u/topic/grade12/parabola/optimization",
    icon: Maximize2,
    title: "בעיות קיצון",
    subtitle: "מקסימום • מינימום • בעיות מילוליות",
    description: "מציאת מקסימום ומינימום של פונקציה ריבועית, תרגום בעיה מילולית למודל ריבועי ופתרונה.",
    chips: ["קודקוד = קיצון", "a>0 → מינימום", "a<0 → מקסימום"],
    ready: true, glowAnim: false,
...
export default function ParabolaHub3u() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-orange-400 text-xs font-semibold uppercase tracking-widest">כיתה י״ב • 3 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">פרבולה</h1>
          <p className="text-slate-400 text-sm">מודל ריבועי • קיצון • בעיות מילוליות</p>
        </div>
