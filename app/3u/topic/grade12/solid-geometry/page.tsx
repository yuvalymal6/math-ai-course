...
import { Brain, ChevronRight, Box, Cylinder } from "lucide-react";

const SUBTOPICS = [
  {
    id: "box-prism",
    href: "/3u/topic/grade12/solid-geometry/box-prism",
    icon: Box,
    title: "תיבה ומנסרה",
    subtitle: "נפח • שטח פנים • אלכסון פאה",
    description: "חישוב נפח ושטח פנים של תיבה ומנסרה, מציאת אלכסון פאה ואלכסון הגוף.",
    chips: ["V = a·b·c", "S = 2(ab+bc+ac)", "אלכסון פאה"],
  ...
  {
    id: "cylinder",
    href: "/3u/topic/grade12/solid-geometry/cylinder",
    icon: Cylinder,
    title: "גליל",
    subtitle: "נפח • שטח פנים • חתך",
    description: "חישוב נפח ושטח פנים של גליל, חתכים מישוריים, ובעיות מילוליות עם גליל.",
    chips: ["V = πr²h", "S = 2πr(r+h)", "חתך"],
    ready: true, glowAnim: false,
...
export default function SolidGeometryHub3u() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-emerald-400 text-xs font-semibold uppercase tracking-widest">כיתה י״ב • 3 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">גופים במרחב</h1>
          <p className="text-slate-400 text-sm">תיבה • גליל • נפח ושטח פנים</p>
        </div>
