...
import { Brain, ChevronRight, Circle, Ruler, PenTool } from "lucide-react";

const SUBTOPICS = [
  {
    id: "basics",
    href: "/5u/topic/grade10/analytic/basics",
    icon: Ruler,
    title: "יסודות",
  ...
  {
    id: "line",
    href: "/5u/topic/grade10/analytic/line",
    icon: PenTool,
    title: "ישר ומשוואתו",
  ...
  {
    id: "circle",
    href: "/5u/topic/grade10/analytic/circle",
    icon: Circle,
    title: "מעגל",
    ...
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-orange-400 text-xs font-semibold uppercase tracking-widest">כיתה י׳ • 5 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">גיאומטריה אנליטית</h1>
          <p className="text-slate-400 text-sm">יסודות • ישר ומשוואתו • מעגל</p>
        </div>
