...
import { Brain, ChevronRight, TrendingUp, LineChart } from "lucide-react";

const SUBTOPICS = [
  {
    id: "linear",
    href: "/5u/topic/grade10/pre-calculus/linear",
    icon: LineChart,
    title: "פונקציה לינארית",
    subtitle: "y = mx + n • שיפוע • חיתוך",
    description: "פונקציה לינארית, שיפוע, חיתוך עם הצירים, ישרים מקבילים וניצבים.",
    chips: ["y = mx + n", "שיפוע", "חיתוך"],
    ready: false,
  ...
  {
    id: "quadratic",
    href: "/5u/topic/grade10/pre-calculus/quadratic",
    icon: TrendingUp,
    title: "פונקציה ריבועית וקיצון",
    subtitle: "y = ax² + bx + c • קודקוד • מקסימום/מינימום",
    description: "פרבולה, קודקוד, ציר סימטריה, חיתוך עם הצירים, ובעיות קיצון.",
    chips: ["y = ax² + bx + c", "קודקוד", "קיצון"],
    ready: false,
...
export default function PreCalculusHub5U() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest">כיתה י׳ • 5 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">קדם אנליזה</h1>
          <p className="text-slate-400 text-sm">פונקציה לינארית • פונקציה ריבועית וקיצון</p>
        </div>
