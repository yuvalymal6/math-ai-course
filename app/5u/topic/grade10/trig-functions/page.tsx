...
import { Brain, ChevronRight, Circle, Compass } from "lucide-react";

const SUBTOPICS = [
  {
    id: "unit-circle",
    href: "/5u/topic/grade10/trig-functions/unit-circle",
    icon: Circle,
    title: "מעגל היחידה וזוויות",
    subtitle: "רדיאנים • זוויות • מעגל",
    description: "מעגל היחידה, מעבר בין מעלות לרדיאנים, זוויות מיוחדות והקשר לטריגונומטריה.",
    chips: ["רדיאן", "π", "מעגל היחידה"],
    ready: false,
  ...
  {
    id: "values",
    href: "/5u/topic/grade10/trig-functions/values",
    icon: Compass,
    title: "ערכי sin / cos / tan",
    subtitle: "ערכים מיוחדים • סימנים • רבעים",
    description: "ערכי פונקציות טריגונומטריות בזוויות מיוחדות, סימנים ברבעים, וזהויות בסיסיות.",
    chips: ["sin 30°", "cos 60°", "tan 45°"],
    ready: false,
...
export default function TrigFunctionsHub5U() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-amber-400 text-xs font-semibold uppercase tracking-widest">כיתה י׳ • 5 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">פונקציות טריגונומטריות</h1>
          <p className="text-slate-400 text-sm">מעגל היחידה וזוויות • ערכי sin / cos / tan</p>
        </div>
