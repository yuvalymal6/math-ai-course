...
import { Brain, ChevronRight, Circle, Triangle } from "lucide-react";

const SUBTOPICS = [
  {
    id: "circles",
    href: "/5u/topic/grade11/geometry/circles",
    icon: Circle,
    title: "מעגלים",
    subtitle: "זוויות • מיתרים • משיקים",
    description: "זוויות במעגל (מרכזית, היקפית, חיצונית), מיתרים, משיקים, מערכת מעגלים ומשפטי כוח.",
    chips: ["זווית מרכזית", "משיק", "כוח נקודה"],
    ready: true,
    glowAnim: false,
  ...
  },
  {
    ...
    href: "/5u/topic/grade11/geometry/triangles-quadrilaterals",
    icon: Triangle,
    title: "משולשים ומרובעים",
    subtitle: "חפיפה • דמיון • שטחים",
    description: "משפטי חפיפה ודמיון, מרובעים חסומים ועוטפים מעגל, חישובי שטח מתקדמים.",
    chips: ["דמיון", "חפיפה", "מרובע חסום"],
    ready: true,
    glowAnim: false,
...
export default function Geometry5UHub() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          ...
          <p className="text-slate-400 text-sm">מעגלים • משולשים ומרובעים</p>
        </div>
