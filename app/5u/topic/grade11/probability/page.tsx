...
const SUBTOPICS = [
  {
    ...
    description: "הגדרת הסתברות, מרחב מדגם, חיתוך ואיחוד אירועים, אירועים בלתי תלויים — P(A∩B) = P(A)·P(B).",
    chips: ["P(A∪B)", "P(A∩B)", "עצמאות"],
    ready: true,
    glowAnim: false,
  ...
  },
  {
    ...
    description: "הסתברות מותנית P(A|B), עצי הסתברות, נוסחת ההסתברות השלמה ונוסחת בייס.",
    chips: ["P(A|B)", "עץ", "בייס"],
    ready: true,
    glowAnim: false,
...
export default function Probability5UHub() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-emerald-400 text-xs font-semibold uppercase tracking-widest">כיתה י״א • 5 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">הסתברות</h1>
          <p className="text-slate-400 text-sm">הסתברות בסיסית ועצמאות • הסתברות מותנית ובייס</p>
        </div>
