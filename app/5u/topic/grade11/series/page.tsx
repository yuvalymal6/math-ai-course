...
import { Brain, ChevronRight, List, Repeat } from "lucide-react";

const SUBTOPICS = [
  {
    id: "arithmetic-geometric",
    href: "/5u/topic/grade11/series/arithmetic-geometric",
    icon: List,
    title: "סדרה חשבונית והנדסית",
    subtitle: "d • q • סכום n איברים",
    description: "סדרה חשבונית — הפרש קבוע, סדרה הנדסית — מנה קבועה, נוסחת האיבר הכללי וסכום n איברים ראשונים.",
    chips: ["aₙ = a₁ + (n−1)d", "aₙ = a₁·qⁿ⁻¹", "Sₙ"],
    ready: true,
    glowAnim: false,
  ...
  {
    id: "induction",
    href: "/5u/topic/grade11/series/induction",
    icon: Repeat,
    title: "אינדוקציה מתמטית",
    subtitle: "בסיס • הנחה • צעד",
    description: "הוכחה באינדוקציה מתמטית — בסיס האינדוקציה, הנחת האינדוקציה וצעד האינדוקציה.",
    chips: ["n = 1", "הנחה: n = k", "הוכחה: n = k+1"],
    ready: true,
    glowAnim: false,
...
export default function Series5UHub() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-amber-400 text-xs font-semibold uppercase tracking-widest">כיתה י״א • 5 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">סדרות</h1>
          <p className="text-slate-400 text-sm">סדרה חשבונית והנדסית • אינדוקציה מתמטית</p>
        </div>
