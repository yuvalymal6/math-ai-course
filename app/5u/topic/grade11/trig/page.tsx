...
import { Brain, ChevronRight, Compass, Maximize2 } from "lucide-react";

const SUBTOPICS = [
  {
    id: "sin-cos-laws",
    href: "/5u/topic/grade11/trig/sin-cos-laws",
    icon: Compass,
  ...
  },
  {
    ...
    description: "חישוב שטח משולש באמצעות טריגונומטריה, שילוב משפטי סינוסים וקוסינוסים בבעיות מורכבות.",
    chips: ["S = ½ab·sinC", "בעיות כלליות", "שילוב משפטים"],
    ready: true,
    glowAnim: false,
...
export default function Trig5UHub() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          ...
          <p className="text-slate-400 text-sm">משפט הסינוסים ומשפט הקוסינוסים • שטחים ובעיות כלליות</p>
        </div>
