...
const exercises: ExerciseDef[] = [
  {
    id: "basic",
    title: "משפט הקוסינוסים — מציאת צלע",
    problem: "במשולש ABC נתונים:\nצלע b, צלע c, וזווית A (הזווית הכלואה ביניהן).\n\nא. הציגו את משפט הקוסינוסים: a² = b² + c² - 2bc·cos A\nב. הציבו את הנתונים וחשבו את a.\nג. בדקו: האם זווית A שווה ל-90°? אם כן, וודאו התאמה למשפט פיתגורס.",
    diagram: <BasicSVG />,
    pitfalls: [
    ...
    goldenPrompt: `היי, אני תלמיד/ה כיתה יא', 5 יחידות, ומצרף/ת שאלה בטריגונומטריה על משפט הקוסינוסים — מציאת צלע במשולש כשנתונות שתי צלעות וזווית כלואה.
אל תפתור עבורי — שאל אותי שאלות מכוונות.
סרוק את הנתונים בלבד.
אל תמהר, תסביר לי על כל שלב. בסיום הסריקה של הנתונים שהדבקתי, תגיב אך ורק: "אני מוכן להמשיך."`,
    steps: [
      { phase: "סעיף א׳", label: "הצגת הנוסחה", coaching: "", prompt: "במשולש ABC נתונים b, c וזווית A. תנחה אותי לרשום את משפט הקוסינוסים a² = b² + c² - 2bc·cos A ולהסביר מתי משתמשים בו.", keywords: [], keywordHint: "", contextWords: ["קוסינוסים", "נוסחה", "צלע", "זווית", "כלואה", "ריבוע"] },
      { phase: "סעיף ב׳", label: "הצבה וחישוב a", coaching: "", prompt: "במשולש ABC נתונים b, c וזווית A. תדריך אותי להציב את הנתונים בנוסחת הקוסינוסים ולחשב את a (לא לשכוח שורש בסוף).", keywords: [], keywordHint: "", contextWords: ["הצבה", "חישוב", "שורש", "cos", "מכפלה", "a"] },
      { phase: "סעיף ג׳", label: "בדיקה עם פיתגורס", coaching: "", prompt: "במשולש ABC חישבתי את a. תנחה אותי לבדוק — אם זווית A = 90° האם a² = b² + c²? איך זה מתחבר למשפט פיתגורס?", keywords: [], keywordHint: "", contextWords: ["פיתגורס", "בדיקה", "ישרה", "90", "אימות", "זווית"] },
    ],
  },
  {
    id: "medium",
...
אל תיתן לי את החישוב — שאל אותי שאלות מנחות על הנוסחה, על שתי הזוויות האפשריות ועל בדיקת התקפות.
סרוק את הנתונים בלבד.
אל תמהר, תסביר לי על כל שלב. בסיום הסריקה של הנתונים שהדבקתי, תגיב אך ורק: "אני מוכן להמשיך."`,
    steps: [
      ...
      <div style={{ borderRadius: 16, border: `1px solid ${s.glowBorder}`, background: "rgba(255,255,255,0.75)", padding: "1.25rem 1.5rem", marginBottom: "2rem", boxShadow: s.glowShadow }}>
        <div style={{ textAlign: "center", marginBottom: 14 }}>
          ...
          <div style={{ color: "#6B7280", fontSize: 12, lineHeight: 1.55 }}>
            {ex.id === "basic" && "משפט הקוסינוסים — מציאת צלע כשנתונות שתי צלעות והזווית הכלואה ביניהן (SAS)."}
