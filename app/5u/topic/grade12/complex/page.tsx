...
import { Brain, ChevronRight, Sparkles, RotateCcw } from "lucide-react";

const SUBTOPICS = [
  {
    id: "algebraic",
    href: "/5u/topic/grade12/complex/algebraic",
    icon: Sparkles,
    title: "צורה אלגברית",
    subtitle: "a + bi • פעולות • שורשים",
    description: "הגדרת מספרים מרוכבים, חיבור, חיסור, כפל וחילוק בצורה אלגברית, מציאת שורשים מרוכבים של פולינומים.",
    chips: ["a + bi", "z·z̄ = |z|²", "שורשים מרוכבים"],
    ready: true,
    glowAnim: false,
  ...
  {
    id: "trigonometric",
    href: "/5u/topic/grade12/complex/trigonometric",
    icon: RotateCcw,
    title: "צורה טריגונומטרית",
    subtitle: "r·cis(θ) • דה-מואבר • שורשים",
    description: "ייצוג טריגונומטרי r(cosθ + i·sinθ), כפל וחילוק, משפט דה-מואבר, שורשי יחידה.",
    chips: ["r·cis(θ)", "דה-מואבר", "שורשי יחידה"],
    ready: true,
    glowAnim: false,
...
export default function Complex5UHub() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-amber-400 text-xs font-semibold uppercase tracking-widest">כיתה י״ב • 5 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">מספרים מרוכבים</h1>
          <p className="text-slate-400 text-sm">צורה אלגברית • צורה טריגונומטרית</p>
        </div>
