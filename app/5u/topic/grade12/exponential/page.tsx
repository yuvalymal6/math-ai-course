...
import { Brain, ChevronRight, TrendingUp, Search } from "lucide-react";

const SUBTOPICS = [
  {
    id: "exp-investigation",
    href: "/5u/topic/grade12/exponential/exp-investigation",
    icon: TrendingUp,
    title: "חקירת פונקציה מעריכית",
    subtitle: "eˣ • aˣ • נגזרת ואינטגרל",
    description: "חקירת פונקציות מעריכיות — תחום, טווח, חד-חד-ערכיות, נגזרת של eˣ ו-aˣ, נקודות קיצון ושרטוט.",
    chips: ["y = eˣ", "(eˣ)' = eˣ", "חקירה מלאה"],
    ready: true,
    glowAnim: false,
  ...
  },
  {
    ...
    href: "/5u/topic/grade12/exponential/log-investigation",
    icon: Search,
    title: "חקירת פונקציה לוגריתמית",
    subtitle: "ln x • log • נגזרת ואינטגרל",
    description: "חקירת פונקציות לוגריתמיות — תחום הגדרה, נגזרת של ln x, אינטגרל, נקודות קיצון ושרטוט.",
    chips: ["y = ln x", "(ln x)' = 1/x", "∫(1/x)dx"],
    ready: true,
    glowAnim: false,
...
export default function Exponential5UHub() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-emerald-400 text-xs font-semibold uppercase tracking-widest">כיתה י״ב • 5 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">פונקציות מעריכיות ולוגריתמיות</h1>
          <p className="text-slate-400 text-sm">חקירת פונקציה מעריכית • חקירת פונקציה לוגריתמית</p>
        </div>
