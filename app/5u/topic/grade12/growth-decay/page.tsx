...
import { Brain, ChevronRight, TrendingDown, Timer } from "lucide-react";

const SUBTOPICS = [
  {
    id: "exponential-models",
    href: "/5u/topic/grade12/growth-decay/exponential-models",
    icon: TrendingDown,
    title: "מודלים מעריכיים",
    subtitle: "גדילה • דעיכה • N(t) = N₀·eᵏᵗ",
    description: "מודלים של גדילה ודעיכה מעריכית — אוכלוסיה, ריכוז, טמפרטורה. בניית משוואה ופתרון.",
    chips: ["N(t) = N₀·eᵏᵗ", "גדילה", "דעיכה"],
    ready: true,
    glowAnim: false,
  ...
  {
    id: "half-life-interest",
    href: "/5u/topic/grade12/growth-decay/half-life-interest",
    icon: Timer,
    title: "חצי חיים וריבית",
    subtitle: "T½ • ריבית דריבית • פחת",
    description: "זמן מחצית חיים, ריבית דריבית רציפה ומחזורית, פחת — יישום מודלים מעריכיים בחיי היום-יום.",
    chips: ["T½ = ln2/k", "A = P·eʳᵗ", "ריבית דריבית"],
    ready: true,
    glowAnim: false,
...
export default function GrowthDecay5UHub() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          <p className="text-rose-400 text-xs font-semibold uppercase tracking-widest">כיתה י״ב • 5 יח&quot;ל</p>
          <h1 className="text-4xl font-extrabold">גדילה ודעיכה</h1>
          <p className="text-slate-400 text-sm">מודלים מעריכיים • חצי חיים וריבית</p>
        </div>
