...
import { Brain, ChevronRight, Move3d, Triangle } from "lucide-react";

const SUBTOPICS = [
  {
    id: "basic-vectors",
    href: "/5u/topic/grade12/vectors/basic-vectors",
    icon: Move3d,
    title: "וקטורים בסיסיים",
    subtitle: "חיבור • מכפלה סקלרית • אורך",
    description: "ייצוג וקטורים במישור ובמרחב, חיבור וחיסור, מכפלה סקלרית, אורך וזווית בין וקטורים.",
    chips: ["ā·b̄ = |a||b|cosθ", "מכפלה סקלרית", "|ā|"],
    ready: true,
    glowAnim: false,
  ...
  {
    id: "pyramid-space",
    href: "/5u/topic/grade12/vectors/pyramid-space",
    icon: Triangle,
    title: "פירמידה ומרחב",
    subtitle: "מישורים • זוויות • מרחק",
    description: "וקטורים במרחב תלת-ממדי, משוואת מישור, זווית בין מישורים, מרחק נקודה ממישור, פירמידה.",
    chips: ["ax+by+cz=d", "זווית מישורים", "פירמידה"],
    ready: true,
    glowAnim: false,
...
export default function Vectors5UHub() {
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white" dir="rtl">
      ...
      <main className="max-w-2xl mx-auto px-4 py-14 space-y-10">
        <div className="text-center space-y-3 animate-[fadeSlideIn_0.4s_ease_both]">
          ...
          <h1 className="text-4xl font-extrabold">וקטורים במרחב</h1>
          <p className="text-slate-400 text-sm">וקטורים בסיסיים • פירמידה ומרחב</p>
        </div>
