...
const TOPICS_3U_11 = [
  { id: "3u-11-growth", title: "גדילה ודעיכה", subtitle: "מודלים מעריכיים", icon: LineChart, href: "/3u/topic/grade11/growth-decay", subtopicLinks: [{ label: "גדילה מעריכית", href: "/3u/topic/grade11/growth-decay/exponential" }, { label: "דעיכה", href: "/3u/topic/grade11/growth-decay/decay" }], color: { bg: "bg-rose-950/40", border: "border-rose-800/50", hover: "hover:border-rose-500/70 hover:shadow-[0_0_32px_rgba(244,63,94,0.18)]", accent: "text-rose-400", icon: "bg-rose-900/60 text-rose-300", bar: "bg-rose-500", badge: "bg-rose-900/60 text-rose-300 border-rose-700/50" } },
