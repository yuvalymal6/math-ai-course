  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <MasterPromptGate
        ...
        subjectWords={CALCULUS_SUBJECT_WORDS}
        subjectHint="חקירת פונקציה / נגזרת / קיצון / פולינום"
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, ease: "easeOut" }}>
          ...
          {allPassed && (
            ...
            >
              ...
              <div style={{ color: "#166534", fontSize: 13, marginTop: 4 }}>בניית פונקציה עם פרמטרים ומערכת משוואות — מאסטר בחשבון!</div>
            </motion.div>
          )}
