  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <MasterPromptGate
        ...
        subjectWords={RATIONAL_SUBJECT_WORDS}
        subjectHint="פונקציה רציונלית / אסימפטוטה / תחום / מכנה"
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, ease: "easeOut" }}>
          ...
          {allPassed && (
            ...
            >
              ...
              <div style={{ color: "#166534", fontSize: 13, marginTop: 4 }}>מציאת פרמטרים מאסימפטוטות — מאסטר בפונקציות רציונליות!</div>
            </motion.div>
          )}
