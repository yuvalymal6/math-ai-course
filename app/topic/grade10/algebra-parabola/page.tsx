...
const exercises: ExerciseDef[] = [
  ...
  },
  {
    ...
    goldenPrompt: `\nהיי, אני תלמיד כיתה י׳, צירפתי לך תמונה של תרגיל פרבולה עם פרמטר.\nהנה הפרוטוקול שלנו, תעבוד לפיו ב-100%:\n1️⃣ סריקה:\nתסרוק את התמונה ותכתוב לי רק:\n"זיהיתי את הנתונים. מחכה לסעיף א'."\n(אל תפתור כלום עדיין!)\n2️⃣ תפקיד:\nאתה המורה שלי. אל תפתור במקומי. בכל סעיף תשאל אותי שאלות מנחות.\n3️⃣ שיטת עבודה:\nאל תמהר, תסביר לי על כל שלב. בסיום הסריקה של הנתונים שהדבקתי, תגיב אך ורק: ״אני מוכן להמשיך.״`,
    steps: [
      {
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: "56rem", margin: "0 auto", padding: "2rem 1rem 5rem" }}>
        ...
        <SubtopicProgress subtopicId="grade10/algebra-parabola" />
        ...
        <div style={{ marginTop: "1.5rem" }}>
          <MarkComplete subtopicId="grade10/algebra-parabola" level={selectedLevel} />
        </div>
