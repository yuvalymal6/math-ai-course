  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <MasterPromptGate
        ...
        subjectWords={["ישר", "שיפוע", "חיתוך", "מקביל", "מאונך", "ניצבות", "משוואת ישר", "נקודת חיתוך", "מרחק", "משולש", "שטח", "זווית ישרה", "קודקוד", "ציר"]}
        subjectHint="ישרים / שיפוע / חיתוך / מקבילים / ניצבות / שטח משולש"
      />
...
const exercises: ExerciseDef[] = [
  {
    ...
    goldenPrompt: `היי, אני תלמיד/ה כיתה י' ומצרף/ת שאלה בגאומטריה אנליטית על חיתוך ישרים ושטח משולש.\nאני רוצה שתהיה המורה הפרטי שלי — תעזור לי להבין ולא לתת תשובות ישירות.\n\nאל תפתור עבורי — שאל אותי שאלות מכווינות.\nסרוק את הנתונים בלבד.\nאל תמהר, תסביר לי על כל שלב. בסיום הסריקה של הנתונים שהדבקתי, תגיב אך ורק: ״אני מוכן להמשיך.״`,
    steps: [
      { phase: "סעיף א׳", label: "מציאת נקודת חיתוך", coaching: "", prompt: "תעזור לי למצוא את הנקודה שבה שני הישרים נפגשים.", keywords: [], keywordHint: "", contextWords: ["חיתוך", "מערכת", "משוואות", "השוואה", "x", "y", "הצבה", "פתרון"] },
      { phase: "סעיף ב׳", label: "מרחק מהראשית", coaching: "", prompt: "מצאתי את נקודת המפגש. כיצד אחשב את המרחק שלה מ-(0,0)?", keywords: [], keywordHint: "", contextWords: ["מרחק", "שורש", "ריבוע", "ראשית", "נוסחה", "פיתגורס", "נקודה"] },
      { phase: "סעיף ג׳", label: "שטח משולש", coaching: "", prompt: "כיצד אמצא את שטח המשולש שנוצר בין שני הישרים וציר x?", keywords: [], keywordHint: "", contextWords: ["שטח", "משולש", "בסיס", "גובה", "ציר", "חצי", "חיתוך", "y=0"] },
    ],
  },
  {
    id: "medium",
    ...
    steps: [
      { phase: "סעיף א׳", label: "משוואת ישר מקביל", coaching: "", prompt: "הכביש מקביל לישר y=3x-2 ועובר דרך (1,7). תעזור לי למצוא את המשוואה.", keywords: [], keywordHint: "", contextWords: ["מקביל", "שיפוע", "שווה", "הצבה", "נקודה", "b", "משוואה", "3"] },
      { phase: "סעיף ב׳", label: "מרחק בין ישרים מקבילים", coaching: "", prompt: "כיצד נחשב את המרחק בין שני ישרים מקבילים?", keywords: [], keywordHint: "", contextWords: ["מרחק", "מקביל", "נוסחה", "שורש", "ערך מוחלט", "b1", "b2", "מכנה"] },
      { phase: "סעיף ג׳", label: "מרחק נקודה מישר", coaching: "", prompt: "P נמצאת על הכביש הראשי ב-x=3. כיצד אמצא את המרחק שלה מהכביש החדש?", keywords: [], keywordHint: "", contextWords: ["מרחק", "נקודה", "ישר", "נוסחה", "הצבה", "P", "שורש", "ערך מוחלט"] },
    ],
  },
  {
    id: "advanced",
    ...
    steps: [
      { phase: "סעיף א׳", label: "מציאת קודקודים", coaching: "", prompt: "תעזור לי למצוא את שלוש הנקודות שבהן הישרים נחתכים.", keywords: [], keywordHint: "", contextWords: ["חיתוך", "מערכת", "משוואות", "קודקוד", "הצבה", "L1", "L2", "L3"] },
      { phase: "סעיף ב׳", label: "הוכחת זווית ישרה", coaching: "", prompt: "כיצד אוכיח שיש זווית ישרה באחד מקודקודי המשולש?", keywords: [], keywordHint: "", contextWords: ["שיפוע", "מכפלה", "מאונך", "ניצב", "הוכחה", "זווית", "ישרה", "-1"] },
      { phase: "סעיף ג׳", label: "שטח המשולש", coaching: "", prompt: "כיצד אחשב את שטח המשולש שקודקודיו מוגדרים על ידי חיתוכי הישרים?", keywords: [], keywordHint: "", contextWords: ["שטח", "משולש", "בסיס", "גובה", "חצי", "ניצב", "מכפלה", "קודקוד"] },
    ],
  },
];
...
function IntersectionLab() {
  ...
  return (
    <section style={{ border: "1px solid rgba(234,88,12,0.35)", borderRadius: "40px", padding: "3rem", background: "rgba(255,255,255,0.82)", backdropFilter: "blur(8px)", marginLeft: "auto", marginRight: "auto", maxWidth: "56rem", boxShadow: "0 10px 15px -3px rgba(60,54,42,0.1)", marginTop: "2rem" }}>
