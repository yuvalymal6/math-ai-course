...
function IntersectionLab() {
  ...
  return (
    <section style={{ border: "1px solid rgba(234,88,12,0.35)", borderRadius: 12, padding: 6, background: "rgba(255,255,255,0.82)", backdropFilter: "blur(8px)", marginLeft: "auto", marginRight: "auto", boxShadow: "0 10px 15px -3px rgba(60,54,42,0.1)", marginTop: "2rem" }}>
