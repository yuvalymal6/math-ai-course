  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <MasterPromptGate
        ...
        subjectWords={["מלבן", "מקבילית", "ריבוע", "אלכסון", "מרכז", "צלע", "קודקוד", "מרחק", "שיפוע", "ניצבות", "סיבוב", "שטח", "היקף", "אורך", "וקטור"]}
        subjectHint="מלבן / מקבילית / ריבוע / אלכסונים / ניצבות / שטח / וקטור סיבוב"
      />
...
function RectangleLab() {
  ...
  return (
    <section style={{ border: "1px solid rgba(225,29,72,0.35)", borderRadius: "40px", padding: "3rem", background: "rgba(255,255,255,0.82)", backdropFilter: "blur(8px)", marginLeft: "auto", marginRight: "auto", maxWidth: "56rem", boxShadow: "0 10px 15px -3px rgba(60,54,42,0.1)", marginTop: "2rem" }}>
