    ...
    <section style={{ border: "1px solid rgba(0,212,255,0.35)", borderRadius: 24, padding: "2.5rem", background: "rgba(255,255,255,0.82)", backdropFilter: "blur(8px)", marginLeft: "auto", marginRight: "auto", boxShadow: "0 10px 15px -3px rgba(60,54,42,0.1)", marginTop: "2rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem", marginBottom: "2rem", background: "rgba(255,255,255,0.75)", borderRadius: 16, border: "1px solid rgba(255,255,255,0.4)", padding: "1.25rem", boxShadow: "0 4px 16px rgba(60,54,42,0.12)" }}>
        <div>
          ...
          <input type="range" min={5} max={20} step={0.5} value={x} onChange={e => { const v = +e.target.value; setX(v); if (v === DEFAULT_X && angleA === DEFAULT_ANGLE) { setShowDefault(true); setTimeout(() => setShowDefault(false), 10000); } else { setShowDefault(false); } }} style={{ width: "100%", accentColor: "#6366f1" }} />
        </div>
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, color: "#6B7280", marginBottom: 4 }}>
            <span>זווית A</span>
          ...
          <input type="range" min={10} max={80} step={1} value={angleA} onChange={e => { const v = +e.target.value; setAngleA(v); if (v === DEFAULT_ANGLE && x === DEFAULT_X) { setShowDefault(true); setTimeout(() => setShowDefault(false), 10000); } else { setShowDefault(false); } }} style={{ width: "100%", accentColor: "#DC2626" }} />
        </div>
      </div>
  ...
  return (
    <section style={{ border: "1px solid rgba(0,212,255,0.35)", borderRadius: 24, padding: "2.5rem", background: "rgba(255,255,255,0.82)", backdropFilter: "blur(8px)", marginLeft: "auto", marginRight: "auto", boxShadow: "0 10px 15px -3px rgba(60,54,42,0.1)", marginTop: "2rem" }}>
      ...
      <div style={{ marginBottom: "2rem", background: "rgba(255,255,255,0.75)", borderRadius: 16, border: "1px solid rgba(255,255,255,0.4)", padding: "1.25rem", boxShadow: "0 4px 16px rgba(60,54,42,0.12)" }}>
        ...
        <input type="range" min={40} max={maxSlider} step={1} value={area} onChange={e => { const v = +e.target.value; setArea(v); if (v === DEFAULT_AREA) { setShowDefault(true); setTimeout(() => setShowDefault(false), 10000); } else { setShowDefault(false); } }} style={{ width: "100%", accentColor: "#10b981" }} />
  ...
  return (
    <section style={{ border: "1px solid rgba(0,212,255,0.35)", borderRadius: 24, padding: "2.5rem", background: "rgba(255,255,255,0.82)", backdropFilter: "blur(8px)", marginLeft: "auto", marginRight: "auto", boxShadow: "0 10px 15px -3px rgba(60,54,42,0.1)", marginTop: "2rem" }}>
      ...
      <div style={{ marginBottom: "2rem", background: "rgba(255,255,255,0.75)", borderRadius: 16, border: "1px solid rgba(255,255,255,0.4)", padding: "1.25rem", boxShadow: "0 4px 16px rgba(60,54,42,0.12)" }}>
        ...
        <input type="range" min={10} max={37} step={1} value={k} onChange={e => { const v = +e.target.value; setK(v); if (v === DEFAULT_K) { setShowDefault(true); setTimeout(() => setShowDefault(false), 10000); } else { setShowDefault(false); } }} style={{ width: "100%", accentColor: "#f59e0b" }} />
      </div>
