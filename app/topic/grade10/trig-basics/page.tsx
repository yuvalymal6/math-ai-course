...
const exercises: ExerciseDef[] = [
  ...
  },
  {
    ...
    goldenPrompt: `\nהיי, אני תלמיד כיתה י׳, צירפתי לך תרגיל על משולש ישר-זווית עם שטח ופיתגורס.\nהנה הפרוטוקול שלנו, תעבוד לפיו ב-100%:\n1️⃣ סריקה:\nתסרוק את הנתונים ותכתוב לי רק:\n"זיהיתי את הנתונים. מחכה להוראות לשלב א'."\n(אל תפתור כלום בשלב הזה!)\n2️⃣ תפקיד:\nאתה מדריך מתמטי ברמה גבוהה. המטרה שלך היא לטפח חשיבה עצמאית ואינטואיציה אלגברית. הימנע ממתן רמזים או צעדים מוקדם מדי. עודד את התלמיד לגשר בעצמו בין נוסחת השטח למשפט פיתגורס. התמקד בלוגיקה המבנית של הבעיה ולא בפתרון המספרי.\n3️⃣ שיטת עבודה:\nאל תמהר, תסביר לי על כל שלב. בסיום הסריקה תגיב אך ורק: ״אני מוכן להמשיך.״`,
    steps: [
